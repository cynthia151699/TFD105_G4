            ...
            f = (i) =>
              new Promise((n, t) => {
                ...
                i.forEach((t, i) => {
                  let s;
                  const o = () => {
                    (t.innerHTML = d[b(0, e - 1)]),
                      (s = setTimeout(o, b(50, 500)));
                  };
                  o();
                  setTimeout(() => {
                    clearTimeout(s),
                      (t.style.opacity = 1),
                      (t.innerHTML = t.dataset.initial),
                      ++h === r && n();
                  }, i * c(40, 0, 8, 200, r));
                });
              }),
          ...
          class h {
            constructor(t) {
              (this.DOM = {
                ...
                this.DOM.titleLetters.forEach(
                  (t) => (t.dataset.initial = t.innerHTML)
                ),
                this.DOM.sideLetters.forEach(
                  (t) => (t.dataset.initial = t.innerHTML)
                ),
                this.calcSizes(),
                this.calcTransforms(),
            ...
            calcTransforms() {
              this.transforms = [
                ...
                {
                  x: -1 * (t.width / 2 - this.width / 2 - 0.075 * t.width),
                  y: 0,
                  rotation: 0,
                },
              ];
                ...
                (this.mouseleaveFn = (t) =>
                  requestAnimationFrame(() => {
                    s &&
                      ...
                      (clearTimeout(this.mousetime),
                      TweenMax.to(
                        [this.DOM.imgWrap, this.DOM.texts.wrap],
                        1.8,
                        {
                          ease: "Power4.easeOut",
                          x: 0,
            ...
            hideTexts(t = !1) {
              t
                ? (g(this.DOM.titleLetters).then(() =>
                    TweenMax.set(this.DOM.texts.wrap, {
                      opacity: 0,
                    })
                  ),
                  g(this.DOM.sideLetters).then(() =>
            ...
            showTexts(t = !0) {
              TweenMax.set(this.DOM.texts.wrap, {
                ...
                t &&
                  (f(this.DOM.titleLetters),
                  f(this.DOM.sideLetters),
          ...
          class i {
            constructor(t) {
              (this.DOM = {
                ...
                (this.DOM.number =
                  this.DOM.el.querySelector(".content__number")),
                (this.DOM.title = this.DOM.el.querySelector(".content__title")),
                (this.DOM.subtitle =
                  this.DOM.el.querySelector(".content__subtitle")),
                (this.DOM.text = this.DOM.el.querySelector(".content__text")),
                (this.DOM.backCtrl =
                  this.DOM.el.parentNode.querySelector(".content__close")),
          ...
          class j {
            constructor(t) {
              if (
                ...
                (this.slides = []),
                Array.from(this.DOM.el.querySelectorAll(".slide")).forEach(
                  (t) => this.slides.push(new h(t))
                ),
              ...
              (this.current = 0),
                ...
                ).forEach((t) => this.contents.push(new i(t))),
                this.render(),
            ...
            render() {
              (this.currentSlide = this.slides[this.current]),
                (this.nextSlide =
                  this.slides[
                    this.current + 1 <= this.slidesTotal - 1
                      ? this.current + 1
                      : 0
                  ]),
                (this.prevSlide =
            ...
            initEvents() {
              ...
              for (let t of this.slides)
                t.DOM.imgWrap.addEventListener("click", () => this.clickFn(t));
              (this.resizeFn = () => {
            ...
            navigate(t) {
              ...
              this.isAnimating ||
                ...
                ("next" === t ? this.nextSlide : this.prevSlide).showTexts(),
                this.upcomingSlide
                  .moveToPosition({
                    position: "next" === t ? 1 : -1,
                    from: "next" === t ? 2 : -2,
                  ...
                  .then(() => {
                    [this.nextSlide, this.currentSlide, this.prevSlide].forEach(
                      (t) => t.reset()
                    ),
                      this.render(),
                      (s = !0),
    ...
    class i {
      constructor(t) {
        (this.DOM = {
          ...
          (this.DOM.backCtrl =
            this.DOM.el.parentNode.querySelector(".content__close")),
          this.DOM.backCtrl.addEventListener("click", () => n.hideContent());
      }
      show() {
        this.DOM.el.classList.add("content__item--current"),
          TweenMax.staggerTo(
    ...
    class j {
      constructor(t) {
        if (
          ...
          (this.slides = []),
          Array.from(this.DOM.el.querySelectorAll(".slide")).forEach((t) =>
            this.slides.push(new h(t))
          ),
          (this.slidesTotal = this.slides.length),
          this.slidesTotal < 4)
        )
      ...
      render() {
        (this.currentSlide = this.slides[this.current]),
          ...
          (this.prevSlide =
            this.slides[
              0 <= this.current - 1 ? this.current - 1 : this.slidesTotal - 1
            ]),
          this.currentSlide.setCurrent(),
          this.nextSlide.setRight(),
          this.prevSlide.setLeft();
      ...
      navigate(t) {
        ...
        this.isAnimating ||
          ...
          this.upcomingSlide
            ...
            .then(() => {
              [this.nextSlide, this.currentSlide, this.prevSlide].forEach((t) =>
                t.reset()
              ),
                this.render(),
                (s = !0),
