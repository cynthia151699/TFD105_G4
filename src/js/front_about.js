...
const messages = {
  ...
  jp: {
    ...
    main: {
      ...
      section8:
        "紀元美術館は、芸術と生活に情熱を持った6人の学生が設立した台北の新興美術館です。教育や文化を広める熱意を持って、博物館の設立を通じて、より多くの人々に芸術に親しむ機会を増やすことを願っています。",
      section9:
        "絵画、彫刻、アニメ、ファッションなど、国内外を問わず幅広いジャンルで、文化性、話題性の高い展覧会を企画し、皆さまに親しみ愛される美術館となるよう、努力しています。当美術館では、約２００点の収蔵作品を活かして、現代美術の流れを展望できるコレクション展示や絵画、ファッション、、彫刻、デザイン等幅広く現代美術に関する展覧会を開催しています。色々な作品を、間近でじっくりとご覧いただけます。",
      section10:
        "紀元美術館は、展覧会を鑑賞したい人々が何のためらいもなく来館できる、すべての人に開かれた「アートへの入口」となることを目指します。",
      section11: "職位:",
      section12: "社長",
      section13: "キュレーター",
      section14: "アートディレクター",
  ...
  tw: {
    ...
    main: {
      ...
      section7: "創造屬於自己的紀元",
      section8:
        "紀元美術館是位於台北市的新興美術館，由六位對藝術與生活充滿熱情的緯育前端班學生創辦。秉持著推廣教育與文化的熱忱，希望藉由博物館的成立，讓更多人擁有親近藝術的機會。",
      section9:
        "企劃繪畫、雕刻、動畫、時尚等等各種類型，具有文化性及話題性的展覽，為了成為大家都喜愛的美術館而努力著。紀元美術館活用約200件收藏作品，除了展示現代美術的發展軌跡也積極開辦繪畫、雕刻、設計等現代美術展覽，讓來訪者可以近距離接觸各式各樣的展覽作品。",
      section10:
        "紀元美術館期望能提供更多親近藝術的機會給大眾，拉近人們與藝術的距離，可以更輕鬆、愜意地將藝術融入生活的一部分，成為為人們開啟「藝術之路」的美術館。",
      section11: "職位:",
      section12: "董事長",
      section13: "策展人",
      section14: "美術總監",
