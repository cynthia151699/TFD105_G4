...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["VueFullpageJs"] = factory();
  else root["VueFullpageJs"] = factory();
})(this, function () {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        !(function (e, t, n, o, r) {
          ...
          function Gn(e, t) {
            return (t = 1 < arguments.length ? t : cn)
          ...
          function _n() {
            return "innerHeight" in an
              ? an.innerHeight
              : cn.documentElement.offsetHeight;
          }
          function Qn() {
          ...
          function wo(e, t, n) {
            ...
            (n = void 0 === n ? {} : n),
              "function" == typeof an.CustomEvent
                ...
                : (o = cn.createEvent("CustomEvent")).initCustomEvent(
                    t,
                    !0,
                    !0,
                    n
          ...
          return (
            ...
            function (e, b) {
              var n =
                  ...
                  -1 < cn.domain.indexOf("alvarotrigo.com"),
                s = Gn("html, body"),
                c = Gn("html")[0],
                g = Gn("body")[0];
              if (!Fn(c, pn)) {
                ...
                var Y,
                  ...
                  G = {};
                en(),
                  (an.fp_easings = Un(an.fp_easings, {
                  ...
                  w &&
                    ...
                    (m.destroy = function (e) {
                      wo(w, "destroy", e),
                        ...
                        an.removeEventListener("resize", Lt),
                        cn.removeEventListener("keydown", dt),
                        cn.removeEventListener("keyup", vt),
                        ...
                        e &&
                          ...
                          Gn(wn + ", " + Cn).forEach(function (e) {
                            b.scrollOverflowHandler &&
                              b.scrollOverflow &&
                              b.scrollOverflowHandler.remove(e),
                              ao(e, Bn + " " + gn + " " + Sn);
                          ...
                          _t(w),
                          [xn, Nn, Rn].forEach(function (e) {
                            Gn(e, w).forEach(function (e) {
                              fo(e);
                            });
                          }),
                          an.scrollTo(0, 0),
                          [bn, kn, In].forEach(function (e) {
                            ao(Gn("." + e), e);
                          }));
                    }),
                    ...
                    (m.test = {
                      ...
                      translate3dH: (function () {
                        for (
                          var e = [], t = 0;
                          t < Gn(b.sectionSelector, w).length;
                          t++
                        )
                    ...
                    b.css3 &&
                      (b.css3 = (function () {
                        ...
                        cn.body.insertBefore(t, null),
                        n))
                          void 0 !== t.style[o] &&
                            ((t.style[o] = "translate3d(1px,1px,1px)"),
                            (e = an
                              .getComputedStyle(t)
                              .getPropertyValue(n[o])));
                        return (
                          cn.body.removeChild(t),
                    ...
                    (function () {
                      if (!b.anchors.length) {
                        var e = "[data-anchor]",
                          t = Gn(
                            b.sectionSelector.split(",").join(e + ",") + e,
                            w
                          );
                        t.length &&
                          t.length === Gn(b.sectionSelector, w).length &&
                          ((Z = !0),
                      ...
                      if (!b.navigationTooltips.length) {
                        var n = "[data-tooltip]",
                          o = Gn(
                            b.sectionSelector.split(",").join(n + ",") + n,
                            w
                          );
                        o.length &&
                          o.forEach(function (e) {
                            b.navigationTooltips.push(
                    ...
                    (function () {
                      Jn(w, { height: "100%", position: "relative" }),
                        ...
                        (y = _n()),
                        ao(w, vn),
                        lo(Gn(b.sectionSelector, w), bn),
                        lo(Gn(b.slideSelector, w), kn),
                        Jt("parallax", "init");
                      for (var e = Gn(wn), t = 0; t < e.length; t++) {
                        ...
                        o.setAttribute(
                          ...
                          b.menu &&
                            b.css3 &&
                            null != vo(Gn(b.menu)[0], un) &&
                            Gn(b.menu).forEach(function (e) {
                              g.appendChild(e);
                            }),
                      ...
                      b.fixedElements &&
                        b.css3 &&
                        Gn(b.fixedElements).forEach(function (e) {
                          g.appendChild(e);
                        }),
                        b.navigation &&
                          (function () {
                            ...
                            var n = Gn(Tn)[0];
                            lo(n, "fp-" + b.navigationPosition),
                              b.showActiveTooltip && lo(n, "fp-show-active");
                            ...
                            (Gn("ul", n)[0].innerHTML = o),
                              lo(
                                Gn("a", Gn("li", Gn(Tn)[0])[no(Gn(yn)[0], wn)]),
                                gn
                              );
                          })(),
                        Gn('iframe[src*="youtube.com/embed/"]', w).forEach(
                          function (e) {
                            var t, n, o;
                            (n = "enablejsapi=1"),
                        ...
                        Jt("cards", "init"),
                        b.scrollOverflow &&
                          (p = b.scrollOverflowHandler.init(b));
                    })(),
                    se(!0),
                    ue(!0),
                    ...
                    Mt(),
                    Dt(),
                    "complete" === cn.readyState && st(),
                    an.addEventListener("load", st),
                    b.scrollOverflow || Ce(),
                    (function () {
                    ...
                    an.addEventListener("resize", Lt),
                    cn.addEventListener("keydown", dt),
                    cn.addEventListener("keyup", vt),
                    ["click", "touchstart"].forEach(function (e) {
              ...
              function re(e, t) {
                ...
                if (b.autoScrolling && !b.scrollBar)
                  Jn(s, { overflow: "hidden", height: "100%" }),
                  ...
                  (Jn(s, { overflow: "visible", height: "initial" }),
              ...
              function le(e, t) {
                "internal" !== t &&
                  Qt("fadingEffect") &&
                  m.fadingEffect.update(e),
                  Qt("cards") && m.cards.update(e),
                ...
                e
                  ? ((function () {
                      ...
                      an.addEventListener
                        ...
                        : ((e = "attachEvent"), (t = "on"));
                      var n =
                          "onwheel" in cn.createElement("div")
                            ? "wheel"
                            : void 0 !== cn.onmousewheel
                            ? "mousewheel"
                            : "DOMMouseScroll",
                        o = !!j && { passive: !1 };
                      "DOMMouseScroll" == n
                        ? cn[e](t + "MozMousePixelScroll", Ye, o)
                        : cn[e](t + n, Ye, o);
                    })(),
                    w.addEventListener("mousedown", pt),
                    w.addEventListener("mouseup", ht))
                  : (cn.addEventListener
                      ? (cn.removeEventListener("mousewheel", Ye, !1),
                        cn.removeEventListener("wheel", Ye, !1),
                        cn.removeEventListener("MozMousePixelScroll", Ye, !1))
                      : cn.detachEvent("onmousewheel", Ye),
                ...
                e
                  ? (ce(!0),
                    (function () {
                      if (
                        (r || i) &&
                        (!Qt("dragAndMove") || "mouseonly" === b.dragAndMove)
                      ) {
                        b.autoScrolling &&
                          (g.removeEventListener(R.touchmove, Ie, {
                            passive: !1,
                          }),
                          g.addEventListener(R.touchmove, Ie, { passive: !1 }));
                        ...
                        e.removeEventListener(R.touchstart, je),
                          ...
                          e.addEventListener(R.touchmove, Ne, { passive: !1 });
                      }
                    })())
                  : (ce(!1),
                    (function () {
                      if (r || i) {
                        b.autoScrolling &&
                          (g.removeEventListener(R.touchmove, Ne, {
                            passive: !1,
                          }),
                          g.removeEventListener(R.touchmove, Ie, {
                            passive: !1,
              ...
              function de() {
                var e = Kn(Gn(yn)[0], wn);
                e || (!b.loopTop && !b.continuousVertical) || (e = to(Gn(wn))),
                  null != e && Ze(e, null, !0);
              }
              function ve() {
                var e = $n(Gn(yn)[0], wn);
                e ||
                  (!b.loopBottom && !b.continuousVertical) ||
                  (e = Gn(wn)[0]),
                  null != e && Ze(e, null, !1);
              }
              function pe(e, t) {
                ...
                if (!Fn(w, vn)) {
                  ...
                  for (var t = Gn(wn), n = 0; n < t.length; ++n) {
                    var o = t[n],
                      ...
                      i = Gn(Cn, o);
                    b.verticalCentered &&
                      Jn(Gn(xn, o), { height: Rt(o) + "px" }),
                      Jn(o, { height: Te(o) + "px" }),
                      1 < i.length && wt(r, Gn(Hn, r)[0]);
                  }
                  b.scrollOverflow && p.createScrollBarForAll();
                  var l = no(Gn(yn)[0], wn);
                  !l || Qt("fadingEffect") || Qt("dropEffect") || pe(l + 1),
                    (E = !1),
                    bo(b.afterResize) &&
                      e &&
                      b.afterResize.call(w, an.innerWidth, an.innerHeight),
                    bo(b.afterReBuild) && !e && b.afterReBuild.call(w),
                    wo(w, "afterRebuild");
                }
              }
              function be() {
              ...
              function we(e) {
                ...
                e
                  ? t ||
                    ...
                    oo(Gn(Tn)),
                    lo(g, fn),
                    bo(b.afterResponsive) && b.afterResponsive.call(w, e),
              ...
              function ye(e) {
                ...
                t && vo(t, Tn + " a")
                  ...
                  : vo(t, b.menu + " [data-menuanchor]") &&
                    function (e) {
                      !Gn(b.menu)[0] ||
                        (!b.lockAnchors && b.anchors.length) ||
                    ...
                    (b.normalScrollElements.split(",").forEach(function (e) {
                      if (!o) {
                        var t = yo(i, e),
                          n = vo(i, e);
                        (t || n) &&
                          (m.shared.isNormalScrollElement ||
                            (ue(!1),
              ...
              function Me(e, t, n) {
                ...
                (c.className = In),
                  ...
                  t.forEach(function (e) {
                    Jn(e, { width: r + "%" }), b.verticalCentered && zt(e);
                  });
                var s = Gn(Hn, e)[0];
                null != s &&
                (0 !== no(Gn(yn), wn) || (0 === no(Gn(yn), wn) && 0 !== no(s)))
                  ? (Xt(s, "internal"), lo(s, "fp-initial"))
                  : lo(t[0], gn);
              }
              function Te(e) {
                return b.offsetSections && m.offsetSections
                  ? Math.round(m.offsetSections.getWindowHeight(e))
                  : _n();
              }
              function Oe(e, t) {
                t || null != Gn(yn)[0] || lo(e, gn),
                  (o = Gn(yn)[0]),
                  Jn(e, { height: Te(e) + "px" }),
                  b.paddingTop && Jn(e, { "padding-top": b.paddingTop }),
                  b.paddingBottom &&
                    Jn(e, { "padding-bottom": b.paddingBottom }),
                  void 0 !== b.sectionsColor[t] &&
                    Jn(e, { "background-color": b.sectionsColor[t] }),
                  void 0 !== b.anchors[t] &&
                    e.setAttribute("data-anchor", b.anchors[t]);
              }
              function ke(e, t, n) {
                var o =
                  "Section" === t
                    ? b.anchors[e]
                    : n.getAttribute("data-anchor");
              ...
              function Ce() {
                ...
                lo(n, Sn),
                  ...
                  bo(b.afterRender) && Xe("afterRender"),
                  wo(w, "afterRender");
              }
              function He() {
                var e;
                if (
                  (wo(w, "onScroll"),
                  !E &&
                    (!b.autoScrolling || b.scrollBar || Qt("dragAndMove")) &&
                    !$t())
                ) {
                  var t = Qt("dragAndMove")
                      ? Math.abs(m.dragAndMove.getCurrentScroll())
                      : go(),
                    n = 0,
                    o = t + _n() / 2,
                    r =
                      (Qt("dragAndMove")
                        ? m.dragAndMove.getDocumentHeight()
                        : g.offsetHeight - _n()) === t,
                    i = Gn(wn);
                  if (r) n = i.length - 1;
                  else if (t)
                  ...
                  if (!Fn((e = i[n]), gn)) {
                    ...
                    p && ((c = p.getAttribute("data-anchor")), (a = no(p))),
                      x &&
                        (lo(e, gn),
                        ao(mo(e), gn),
                        Jt("parallax", "afterLoad"),
                        bo(b.onLeave) && Xe("onLeave", h),
                        bo(b.afterLoad) && Xe("afterLoad", h),
                        Qt("resetSliders") &&
                          m.resetSliders.apply({
                            localIsResizing: E,
                            leavingSection: u,
                          }),
                        tt(s),
              ...
              function Re(e) {
                if (v.m[e]) {
                  var t = "down" === e ? ve : de;
                  if (
                    (Qt("scrollHorizontally") &&
                      (t = m.scrollHorizontally.getScrollSection(e, t)),
                    b.scrollOverflow)
                  ) {
              ...
              function Ne(e) {
                ...
                if (Be(e)) {
                  ...
                  ($ = n.y),
                    (q = n.x),
                    Gn(Rn, t).length && Math.abs(K - q) > Math.abs(J - $)
                      ? !a &&
                        Math.abs(K - q) > (Qn() / 100) * b.touchSensitivity &&
                        (q < K ? v.m.right && ge(t) : v.m.left && me(t))
                      : b.autoScrolling &&
                        x &&
                        Math.abs(J - $) >
                          (an.innerHeight / 100) * b.touchSensitivity &&
                        ($ < J ? Re("down") : J < $ && Re("up"));
                }
              }
              function Be(e) {
              ...
              function Ye(e) {
                ...
                if (b.autoScrolling && !u && !n) {
                  var o =
                      (e = e || an.event).wheelDelta || -e.deltaY || -e.detail,
              ...
              function Ve(e) {
                var t = e.offsetHeight,
                  ...
                  o = n,
                  r =
                    Qt("dragAndMove") && m.dragAndMove.isGrabbing
                      ? m.dragAndMove.isScrollingDown()
                      : te < n,
                  i = o - y + t,
                ...
                return (
                  ...
                  b.offsetSections &&
                    m.offsetSections &&
                    (o = m.offsetSections.getSectionPosition(r, o, e)),
                  (te = o)
                );
              }
              function Ze(e, t, n) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      if (
                        ...
                        (i.direction = l),
                        void 0 !== an.fp_dropEffectExtension &&
                          m.dropEffect.onLeave(i),
                        bo(b.onLeave) && !1 === Xe("onLeave", i))
                      )
                        return;
                    }
                    var a;
                    Jt("parallax", "apply", i),
                      ...
                      b.autoScrolling &&
                        ...
                        ((c = i).isMovementUp
                          ? ho(Gn(yn)[0], Ao(c.activeSection, wn))
                          : po(Gn(yn)[0], Mo(c.activeSection, wn).reverse()),
                        Gt(Gn(yn)[0].offsetTop),
                        De(),
                        (c.wrapAroundElements = c.activeSection),
                        (c.dtop = c.element.offsetTop),
                        (c.yMovement = Ct(c.element)),
                        (c.leavingSection = no(c.activeSection, wn) + 1),
                        (c.sectionIndex = no(c.element, wn)),
                        wo(Gn(un)[0], "onContinuousVertical", c),
                        (i = c)),
                      Qt("scrollOverflowReset") &&
                        m.scrollOverflowReset.setPrevious(i.activeSection),
                      i.localIsResizing || tt(i.activeSection),
                      b.scrollOverflow && b.scrollOverflowHandler.beforeLeave(),
                      (Qt("dropEffect") && b.dropEffect) ||
                        (lo(e, gn), ao(mo(e), gn)),
                      Ke(e),
              ...
              function _e(e) {
                ...
                null != (t = e).wrapAroundElements &&
                  ...
                  bo(b.afterLoad) && !e.localIsResizing && Xe("afterLoad", e),
                  b.scrollOverflow && b.scrollOverflowHandler.afterLoad(),
                  Jt("parallax", "afterLoad"),
                  Jt("dropEffect", "afterLoad"),
                  Jt("scrollOverflowReset", "reset"),
                  Qt("resetSliders") && m.resetSliders.apply(e),
              ...
              function qe(e) {
                ...
                Gn("video, audio", t).forEach(function (e) {
                  ...
                  Gn('iframe[src*="youtube.com/embed/"]', t).forEach(function (
                    e
                  ) {
                ...
                function o(e) {
                  ...
                  for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); c < e.length; )
                    (t =
                      ...
                      ((r = s.indexOf(e.charAt(c++))) >> 4)),
                      (n =
                        ((15 & r) << 4) |
                        ((i = s.indexOf(e.charAt(c++))) >> 2)),
                  ...
                  e.forEach(function (e) {
                    ...
                    var f = m ? ot(e) : "",
                      d =
                        ...
                        -1 < f[1].indexOf(g, f[1].length - g.length),
              ...
              function at(e) {
                if (
                  ...
                  N ||
                    (U = U.replace("extensions/", "").replace("Extension", "")),
                  (F.innerHTML = U),
                  (F = F.firstChild),
                  "MutationObserver" in an &&
                    new MutationObserver(it).observe(cn.body, {
                      childList: !0,
                      subtree: !1,
                    }),
                  (!N || (Qt(e) && m[e])) && (!rt(e) || !N))
              ...
              function ct() {
                F &&
                  (I || (Math.random() < 0.5 ? To(g, F) : co(F, g), (I = !0)),
                  F.setAttribute(
                    "style",
                    ot(
              ...
              function pt(e) {
                2 == e.which &&
                  ((ne = e.pageY), w.addEventListener("mousemove", bt));
              }
              function ht(e) {
                ...
                (r.xMovement = Ht(r.prevSlideIndex, r.slideIndex)),
                  ...
                  !1 === Xe("onSlideLeave", r)
                    ...
                    : ((Qt("dropEffect") && b.dropEffect) ||
                      ...
                      b.interlockedSlides &&
                        m.interlockedSlides &&
                        ((Qt("continuousHorizontal") &&
                          void 0 !== n &&
                          n !== r.xMovement) ||
                          m.interlockedSlides.apply(r)));
              }
              function yt(e) {
                !b.loopHorizontal &&
                  b.controlArrows &&
              ...
              function Et(e) {
                var t, n;
                m.continuousHorizontal &&
                  m.continuousHorizontal.afterSlideLoads(e),
                  (t = e.slidesNav),
                  (n = e.slideIndex),
                  b.slidesNavigation &&
                    null != t &&
                  ...
                  e.localIsResizing ||
                    ...
                    Jt("scrollOverflowReset", "reset"),
                    bo(b.afterSlideLoad) && Xe("afterSlideLoad", e),
                    (x = !0),
                    qe(e.destiny)),
                  (a = !1),
                  Qt("interlockedSlides") && m.interlockedSlides.apply(e);
              }
              function xt(e, t, n) {
                var o = t.destinyPos;
                if (b.css3) {
                  ...
                  (m.test.translate3dH[t.sectionIndex] = r),
                    (Qt("dragAndMove") && void 0 !== t.isInterlockedSlide) ||
                      Tt(Gn(Nn, e)),
                    Jn(Gn(Nn, e), Ut(r)),
                  ...
                  (m.test.left[t.sectionIndex] = Math.round(o.left)),
                    tn(e, Math.round(o.left), b.scrollingSpeed, function () {
                      n && Et(t);
                    });
              }
              function Lt() {
              ...
              function Tt(e) {
                ...
                return (
                  ao(e, dn), Jn(e, { "-webkit-transition": t, transition: t })
                );
              }
              function Ot(e) {
                return lo(e, dn);
              ...
              function Qt(e) {
                return null !== b[e] &&
                  "[object Array]" === Object.prototype.toString.call(b[e])
                  ? b[e].length && m[e]
                  : b[e] && m[e];
              }
              function Jt(e, t, n) {
              ...
              function tn(t, n, o, r) {
                ...
                var c = function () {
                  if (Y) {
                    var e = n;
                    (a += 20),
                      o && (e = an.fp_easings[b.easing](a, i, l, o)),
                      nn(t, e),
              ...
              function nn(e, t) {
                !b.autoScrolling || b.scrollBar || (e.self != an && Fn(e, zn))
                  ? e.self != an && Fn(e, zn)
                    ? (e.scrollLeft = t)
                    : e.scrollTo(0, t)
                  : (e.style.top = t + "px");
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Component.options.__file =
          "/Users/alvarotrigolopez/Sites/vue-fullpage.js/src/FullPage.vue";
        if (
          Component.esModule &&
          Object.keys(Component.esModule).some(function (key) {
        ...
        if (Component.options.functional) {
          console.error(
            "[vue-loader] FullPage.vue: functional components are not supported with templates, they should use render functions."
          );
        }
        ...
        exports.default = {
          methods: {
            build: function build() {
              ...
              var activeSectionIndex = fp_utils.index(
              ...
              var activeSlideIndex = activeSlide
            ...
            emitEvent: function emitEvent(name, args) {
              ...
              this.$emit.apply(
                this,
                [camelToKebab(name)].concat(_toConsumableArray(args))
              );
            ...
            init: function init() {
              ...
              this.api = new _fullpageExtensions2.default(
                this.$refs.fullpage,
                this.options
              );
            },
            ...
            return {
              events: constants.EVENTS.reduce(function (eventsHandlers, event) {
                return _extends(
                  {},
                  eventsHandlers,
                  _defineProperty({}, event, function () {
                    for (
