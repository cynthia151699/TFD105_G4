...
window.onload = function () {
    ...
    document.getElementsByClassName('input_coupon')[0].value = sessionStorage.getItem('DISCOUNTCODE');
    ...
    checkoutButton.addEventListener('click', function () { //checkout按鈕按下去觸發的事件
